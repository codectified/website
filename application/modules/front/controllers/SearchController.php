...
class SearchController extends SController
{
    ...
    public function actionSearch()
    {
        ...
        $this->view->params['_searchMode'] = $mode;

        $page = Yii::$app->request->get('page', 1);
        $page = intval($page);
        return $this->processSearch($query, $page, $collections, $mode);
    }

    public function processSearch($query, $page, $collections, $mode = 'lexical')
    {
